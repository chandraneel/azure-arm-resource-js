...
export declare class Subscriptions {
     ...
     */
    listLocationsWithHttpOperationResponse(subscriptionId: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse>;
    /**
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    getWithHttpOperationResponse(subscriptionId: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse>;
    /**
