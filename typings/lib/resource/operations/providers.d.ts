...
export declare class Providers {
     ...
     */
    unregisterWithHttpOperationResponse(resourceProviderNamespace: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse>;
    /**
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    registerWithHttpOperationResponse(resourceProviderNamespace: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse>;
    /**
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    listWithHttpOperationResponse(options?: Models.ProvidersListOptionalParams): Promise<msRest.HttpOperationResponse>;
    /**
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    getWithHttpOperationResponse(resourceProviderNamespace: string, options?: Models.ProvidersGetOptionalParams): Promise<msRest.HttpOperationResponse>;
    /**
     * Gets all resource providers for a subscription.
     *
