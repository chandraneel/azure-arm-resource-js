...
export declare class Tags {
     ...
     */
    deleteValueWithHttpOperationResponse(tagName: string, tagValue: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse>;
    /**
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    createOrUpdateValueWithHttpOperationResponse(tagName: string, tagValue: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse>;
    /**
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    createOrUpdateWithHttpOperationResponse(tagName: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse>;
    /**
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    deleteMethodWithHttpOperationResponse(tagName: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse>;
    /**
